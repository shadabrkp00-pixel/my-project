...
if not st.session_state['logged_in']:
    ...
    st.subheader("Please enter your credentials to access the predictor.")
...
# --- MAIN APP LOGIC ---
    ...
    def train_model():
        ...
        # The 5 requested parameters are dropped here
        df = df.drop(columns=[
    ...
    if st.button("Predict Score", use_container_width=True):
        ...
        all_inputs = [hours_studied, attendance, previous_scores,
                      access_to_resources, internet_access, gender]
